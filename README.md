...
uscs/0.1.3 darwin-x64 node-v10.15.3
$ uscs --help [COMMAND]
USAGE
  $ uscs COMMAND
...
...
_See code: [src/commands/containers.ts](https://github.com/mtk3d/uscs/blob/v0.1.3/src/commands/containers.ts)_
...
_See code: [src/commands/init.ts](https://github.com/mtk3d/uscs/blob/v0.1.3/src/commands/init.ts)_
...
_See code: [src/commands/mysql.ts](https://github.com/mtk3d/uscs/blob/v0.1.3/src/commands/mysql.ts)_
...
_See code: [src/commands/run.ts](https://github.com/mtk3d/uscs/blob/v0.1.3/src/commands/run.ts)_
<!-- commandsstop -->
